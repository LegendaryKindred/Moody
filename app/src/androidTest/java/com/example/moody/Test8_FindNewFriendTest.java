...
public class Test8_FindNewFriendTest {
    ...
    @Test
    public void test8_FindNewFriendTest() {
        ...
        ViewInteraction navigationMenuItemView = onView(
                allOf(withId(R.id.new_friend_menu),
                        childAtPosition(
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.friendSearchEditText),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.friendSearchButton), withText("Search"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.FrameLayout")),
                                        0),
        ...
        ViewInteraction appCompatImageButton2 = onView(
                allOf(withId(R.id.new_friend_add),
                        childAtPosition(
                                childAtPosition(
