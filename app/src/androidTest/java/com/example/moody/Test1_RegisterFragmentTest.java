        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.registerUsername),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("test12"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText12 = onView(
                allOf(withId(R.id.registerPassword),
                        childAtPosition(
                                ...
                                5),
                        isDisplayed()));
        appCompatEditText12.perform(replaceText("qwertyui"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText14 = onView(
                allOf(withId(R.id.registerPhone),
                        childAtPosition(
                                ...
                                6),
                        isDisplayed()));
        appCompatEditText14.perform(replaceText("6080000000"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText15 = onView(
                allOf(withId(R.id.registerPassword), withText("qwertyui"),
                        childAtPosition(
                                ...
                                5),
                        isDisplayed()));
        appCompatEditText15.perform(replaceText("qwerty"));

        ViewInteraction appCompatEditText16 = onView(
                allOf(withId(R.id.registerPassword), withText("qwerty"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.RelativeLayout")),
                                        0),
        ...
        ViewInteraction appCompatEditText17 = onView(
                allOf(withId(R.id.registerPassword), withText("qwerty"),
                        childAtPosition(
                                ...
                                5),
                        isDisplayed()));
        appCompatEditText17.perform(replaceText("qwertyui"));
